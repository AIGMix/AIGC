...
#define AIGC_JSON_HELPER(...)                                                          \
    ...
    {                                                                                  \
        ...
        return handle.SetMembers(names, 0, jsonValue, __VA_ARGS__);                    \
    }                                                                                  \
...
#define AIGC_JSON_HELPER_BASE(...)                                           \
    ...
    public:
        ...
        {
            return obj.AIGCBaseObjectToJson(jsonValue, allocator);
        }
    ...
    public:
        ...
        ******************************************************/
        ...
        {
            if (!SetMembers(names, index, jsonValue, arg))
                return false;

            return SetMembers(names, ++index, jsonValue, args...);
        }
